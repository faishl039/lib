    ...
    <form class="bg-[#4A91E8] flex items-center justify-center" method="POST" enctype="multipart/form-data">
        ...
        <div class= "w-1/2 mt-[50px]">
            <div class="form-group mb-5">
                <input type="text" id="title" name="title" placeholder="Judul Makalah" class="@error('title') error @enderror" value="{{ old('title') }}">
                @error('title')
            ...
            <div class="form-group mb-5">
                <input type="text" id="author" name="author" placeholder="Penulis" class="@error('author') error @enderror" value="{{ old('author') }}">
                @error('author')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group mb-5">
                <input type="text" id="seminar_name" name="seminar_name" placeholder="Nama Seminar/Konferensi/Simposium" value="{{ old('seminar_name') }}"
                    class="@error('seminar_name') error @enderror">
                @error('seminar_name')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="form-group mb-5">
                <input type="text" id="penyelenggara" name="penyelenggara" value="{{ old('penyelenggara') }}"
                    placeholder="Penyelenggara Seminar/Konferensi/Simposium" class="@error('penyelenggara') error @enderror">
                @error('penyelenggara')
                    <p class="error">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-5">
                <label for="file" class="block text-white text-sm font-medium">Unggah File Makalah</label>
